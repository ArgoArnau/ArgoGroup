  ...
  return (
    <section id="services" className="py-24 bg-[#111111]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Each service card fades in one after another */}
        <div className="grid grid-cols-1 gap-8">
          {t.services.items.map((service, idx) => (
            <FadeIn key={service.title} delay={idx * 150} duration={700} translateY={32}>
              <div className="group relative p-8 bg-dark-surface border border-dark-border rounded-xl hover:border-gold/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(212,175,55,0.08)]">
                  ...
                  {service.sections.map((section) => (
                    <div key={section.heading}>
                      {section.heading ? (
                        ...
                        <div className="text-xs mb-3 border-b border-transparent pb-2 invisible select-none">&nbsp;</div>
                      )}
                      {section.headline && (
