    ...
    <section className="min-h-screen py-32 bg-dark">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 text-gray-400 text-sm leading-relaxed">
          ...
          {/* 1 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">1. About These Terms</h2>
            <p>
          ...
          {/* 2 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">2. Services</h2>
            <p>
          ...
          {/* 3 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">3. Engagement Model</h2>
            <p>
          ...
          {/* 4 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">4. Billing & Payment</h2>

            <h3 className="text-white font-semibold text-sm mt-4 mb-2">4.1 Billing Cycle</h3>
            <p>
            ...
            <h3 className="text-white font-semibold text-sm mt-4 mb-2">4.2 Pro-Rated Billing Upon Cancellation</h3>
            <p>
            ...
            <h3 className="text-white font-semibold text-sm mt-4 mb-2">4.3 Payment Terms</h3>
            <p>
          ...
          {/* 5 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">5. Cancellation Policy</h2>
            ...
            <h3 className="text-white font-semibold text-sm mt-4 mb-2">5.3 Work in Progress</h3>
            <p>
            ...
            <h3 className="text-white font-semibold text-sm mt-4 mb-2">5.4 ARGO-Initiated Cancellation</h3>
            <p>
          ...
          {/* 6 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">6. No Guarantee of Results</h2>
            <p>
          ...
          {/* 7 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">7. AI & Automation Disclosure</h2>
            <p>
          ...
          {/* 8 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">8. Client Responsibilities</h2>
          ...
          {/* 9 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">9. Intellectual Property</h2>

            <h3 className="text-white font-semibold text-sm mt-4 mb-2">9.1 Client Ownership</h3>
            <p>
          ...
          {/* 10 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">10. Confidentiality</h2>
            <p>
          ...
          {/* 11 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">11. Limitation of Liability</h2>
            <p>
          ...
          {/* 12 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">12. Data Protection & Privacy</h2>

            <h3 className="text-white font-semibold text-sm mt-4 mb-2">12.1 General</h3>
            <p>
            ...
            <h3 className="text-white font-semibold text-sm mt-4 mb-2">12.4 Third-Party Platforms</h3>
            <p>
          ...
          {/* 13 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">13. Governing Law & Dispute Resolution</h2>

            <h3 className="text-white font-semibold text-sm mt-4 mb-2">13.1 Primary Governing Law</h3>
            <p>
            ...
            <h3 className="text-white font-semibold text-sm mt-4 mb-2">13.2 EU Consumer Protection</h3>
            <p>
            ...
            <h3 className="text-white font-semibold text-sm mt-4 mb-2">13.3 Dispute Resolution</h3>
            <p>
          ...
          {/* 14 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">14. Changes to These Terms</h2>
            <p>
          ...
          {/* 15 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">15. Entire Agreement</h2>
            <p>
          ...
          {/* 16 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">16. Contact</h2>
