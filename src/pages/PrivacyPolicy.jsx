    ...
    <section className="min-h-screen py-32 bg-dark">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 text-gray-400 text-sm leading-relaxed">
          ...
          {/* 1 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">1. Who We Are</h2>
            <p>
          ...
          {/* 2 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">2. Scope of This Policy</h2>
            <p>
          ...
          {/* 3 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">3. Data We Collect</h2>
            <p className="mb-3">We collect personal data in the following ways:</p>
            <ul className="space-y-3">
              <li>
                <span className="text-white font-medium">Contact Form Submissions:</span> When you fill out a form on our website, we collect your name, email address, company name, phone number (if provided), subject, and message content.
              </li>
              <li>
                <span className="text-white font-medium">Cookies and Analytics:</span> We use cookies and similar tracking technologies to understand how visitors interact with our website, measure performance, and improve user experience. This may include session data, page views, referral sources, and device information.
              </li>
              <li>
                <span className="text-white font-medium">Client Service Data:</span> As part of delivering our services — including performance marketing campaigns, CRM integrations, and automation workflows — we may process data you share with us relating to your business, customers, and operations.
              </li>
              <li>
                <span className="text-white font-medium">Communication Data:</span> When you communicate with us via email, WhatsApp, or Slack, we retain those communications for service continuity and support purposes.
              </li>
            </ul>
          </div>
          ...
          {/* 4 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">4. How We Use Your Data</h2>
          ...
          {/* 5 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">5. Third-Party Tools and Service Providers</h2>
            <p className="mb-3">
              We use third-party platforms to operate our business and deliver services. These fall into the following categories:
            </p>
            <ul className="space-y-2 list-disc list-inside">
              <li><span className="text-white font-medium">CRM Platforms:</span> Tools such as HubSpot and Pipedrive to manage leads and client data</li>
              <li><span className="text-white font-medium">Analytics Tools:</span> Platforms used to track website traffic and campaign performance</li>
              <li><span className="text-white font-medium">Email and Communication Tools:</span> Services used to manage client communications and automated email sequences</li>
              <li><span className="text-white font-medium">Automation Platforms:</span> Tools including n8n and Make used to build and run workflow automations</li>
              <li><span className="text-white font-medium">Advertising Platforms:</span> Meta Ads, Google Ads, TikTok Ads, and LinkedIn Ads, through which campaign data is processed</li>
              <li><span className="text-white font-medium">AI Tools:</span> Artificial intelligence platforms used in service delivery, content generation, and data processing</li>
            </ul>
            <p className="mt-3">
          ...
          {/* 6 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">6. AI and Automation Disclosure</h2>
            <p>
          ...
          {/* 7 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">7. Data Retention</h2>
            <p>
          ...
          {/* 8 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">8. International Data Transfers</h2>
            <p>
          ...
          {/* 9 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">9. Your Rights (GDPR — EU Users)</h2>
            <p className="mb-3">If you are located in the European Union, you have the following rights under the GDPR:</p>
            <ul className="space-y-2 list-disc list-inside">
              ...
              <li><span className="text-white font-medium">Right to Erasure:</span> Request deletion of your personal data ("right to be forgotten")</li>
              <li><span className="text-white font-medium">Right to Restriction:</span> Request that we limit the processing of your data</li>
              <li><span className="text-white font-medium">Right to Data Portability:</span> Receive your data in a structured, machine-readable format</li>
              <li><span className="text-white font-medium">Right to Object:</span> Object to processing based on legitimate interests or for direct marketing</li>
              <li><span className="text-white font-medium">Right to Withdraw Consent:</span> Withdraw consent at any time where processing is based on consent</li>
            </ul>
          </div>

          {/* 10 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">10. Your Rights (US Users)</h2>
            <p>
              Depending on your state of residence, you may have the right to access, correct, or delete the personal information we hold about you. You may also have the right to opt out of certain data processing activities. To make any such request, contact us at <a href="mailto:privacy@argoagency.com" className="text-gold hover:underline">privacy@argoagency.com</a> and we will respond within 30 days.
            </p>
          </div>

          {/* 11 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">11. Cookies</h2>
            <p>
          ...
          {/* 12 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">12. Security</h2>
            <p>
          ...
          {/* 13 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">13. Changes to This Policy</h2>
            <p>
          ...
          {/* 14 */}
          <div>
            <h2 className="font-serif text-xl font-bold text-white mb-3">14. Contact Us</h2>
            <p>
